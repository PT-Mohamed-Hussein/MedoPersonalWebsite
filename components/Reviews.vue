...
<template>
    <div class="p-8 bg-primary-3">
        <h2 class="m-auto tracking-wide mb-6 font-bold font-header text-secondary-mint text-2xl border-b w-fit">
            Patients Reviews
        </h2>
        <div class=" container m-auto flex justify-around items-center gap-8">
            <swiper
                :slidesPerView="1"
                :spaceBetween="30"
                :breakpoints="{
